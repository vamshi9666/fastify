...
warning.create('FastifySecurity', 'FSTSEC001', 'You are using /%s/ Content-Type which may vulnerable to CORS attack. Please make sure your RegExp start with "^" or include ";?" to proper detect the essence MIME type.')
